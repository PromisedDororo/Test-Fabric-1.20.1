package net.dororo.tutorialmod.block;
...
public class ModBlocks {
    ...
    public static final Block RAW_RUWBY_BLOCK = registerBlock("raw_ruby_block", new Block(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).sounds(BlockSoundGroup.AMETHYST_BLOCK)));
